...
const translations = {
    ru: {
        ...
        hero_title: 'Раскрываю творческий потенциал детей и взрослых через персональный подход.',
        hero_text: 'Обучение живописи для детей и взрослых, арт-терапия, нейрографика и консультации по квантовой астрогенетике.\n\nПровожу занятия онлайн и офлайн в Ойскирхене. Обучение проходит на русском и украинском языках и подходит для детей из русско- и украиноязычных семей, проживающих в Германии и за её пределами.',
        ...
        services_subtitle: 'Персональное обучение живописи, терапевтические практики и персональные консультации по индивидуальному запросу с использованием квантовых инструментов.',
        tag_kids: '5–15 лет',
        tag_teens: 'от 10 лет',
        tag_all: 'для всех',
        tag_online: 'онлайн',
        ...
        service_2_desc: 'Серьёзные занятия для подростков и взрослых с углублённым изучением техники масляной живописи. Раскрытие секретов и тонкостей создания художественных полотен.',
        ...
        service_5_desc: 'Раскрытие планетарного потенциала ребёнка и взрослого по дате рождения. Рекомендации по выбору направлений дальнейшего обучения и коррекции возможных психологических состояний.',
        service_6_title: 'Световые карты',
        service_6_desc: 'Квантовый инструмент работы с тонким планом через персональные световые метафорические расклады. «Неопределённость событий можно сделать определённой».',
        about_label: 'Обо мне',
        about_title: 'Творчество как путь к себе',
        about_p1: 'Верю, что каждый ребёнок талантлив по-своему, и моя задача — помочь раскрыть этот талант. Обучаю различным техникам живописи, используя индивидуальный подход к каждому ученику. Учу детей рисовать карандашом, акрилом и маслом на холсте, развиваю творческое мышление, художественные навыки и уверенность в себе.',
        about_p2: 'Помимо изобразительного искусства, провожу арт-терапевтические занятия и нейрографику для детей и взрослых, помогая снять стресс и восстановить внутренний баланс через творчество. Также консультирую родителей, раскрывая планетарный потенциал детей по дате рождения.',
        ...
        gallery_subtitle: 'Авторские работы и творческие проекты учеников, выполненные в различных художественных техниках.',
        ...
        form_text: 'Напишите мне в Telegram, WhatsApp или на электронную почту, и мы договоримся об удобном времени и формате занятий.',
        form_note: 'Занятия и консультации проходят в Ойскирхене, онлайн, а также возможны занятия на дому. Первое знакомство возможно в формате онлайн-консультации, чтобы выбрать наиболее подходящий метод обучения или формат общения.',
